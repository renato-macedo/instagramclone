...
import { View, TextInput, Image, Text, StyleSheet, TouchableOpacity, KeyboardAvoidingView } from 'react-native';
        ...
        ImagePicker.showImagePicker({
            ...
            if (upload.error) {
                ...
                if (upload.fileName) {
                    ...
                    ext = ext.toLowerCase() === 'heic' ? 'jph' : ext;
                } else {
